    ...
    >
      ...
      <div className="absolute top-6 left-6 z-20 flex space-x-4">
        <a
          ...
          className="flex items-center justify-center w-12 h-12 bg-white/10 backdrop-blur-sm rounded-full hover:bg-white/20 transition-all duration-300 hover:scale-110"
